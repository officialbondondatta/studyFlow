...
const Banner = () => {
    return (
        <div className="mt-20 flex items-center justify-center flex-col space-y-5 p-5 lg:p-0">
            ...
            <h2 className="max-w-190 lg:text-5xl text-3xl text-center font-bold">Turn big goals into daily tasks you'll actually finish
            </h2>
            ...
            <div className="card bg-base-100 mt-4 rounded-xl border border-slate-300">
                <div className="px-5 py-5 space-y-2">
                    ...
                    <div className="py-3 px-2 border border-slate-300 rounded-xl line-through text-slate-500">
                        <p className="flex lg:w-96   items-center gap-2"><FaRegCheckCircle className="text-[#0e7c66]" />Solve 10 integration problems</p>
                    </div>
                    <div className="py-3 px-2 border border-slate-300 rounded-xl line-through text-slate-500">
                        <p className="flex lg:w-96  items-center gap-2"><FaRegCheckCircle className="text-[#0e7c66]" />Read Chapter 4: Cell Structures</p>
                    </div>
                    <div className="py-3 px-2 border border-slate-300 rounded-xl line-through text-slate-500">
                        <p className="flex lg:w-96 items-center gap-2"><FaRegCheckCircle className="text-slate-300" />Write essay outline</p>
                    </div>
                </div>
            </div>
        </div>
